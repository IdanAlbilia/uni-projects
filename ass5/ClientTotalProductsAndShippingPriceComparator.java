...
public class ClientTotalProductsAndShippingPriceComparator implements Comparator {
	/**
	 * This comparator is defined by if the the final price of the second client is bigger it will returns positive if the same 0 and if the second have less total price it returns negative number
	 */
	@Override
	public int compare(Object o1, Object o2) {
		...
		return (int) (secondClient.computeFinalOrderPrice()-firstClient.computeFinalOrderPrice());
	}
